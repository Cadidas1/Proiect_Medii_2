...
namespace Proiect_Medii_2.Models
{
    public class CategoriiMasinaPageModel:PageModel
    {
        ...
        public void PopulateCategorieAtribuitaMasinii(Proiect_Medii_2Context context,
        Masina masina)
        {
        ...
        public void UpdateCategoriiMasina(Proiect_Medii_2Context context,
            ...
            foreach (var cat in context.Categorie)
            {
                ...
                else
                {
                    if (Categoriimasina.Contains(cat.ID))
                    {
                        ...
                        = masinaToUpdate
                        .CategoriiMasina.SingleOrDefault(i => i.CategorieID == cat.ID);
